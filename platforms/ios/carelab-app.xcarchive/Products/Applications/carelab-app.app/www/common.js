...
/* harmony import */ var _shared_enums_localstroage_local_storage_item_keys_enum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @shared/enums/localstroage/local-storage-item-keys.enum */ "./src/app/shared/enums/localstroage/local-storage-item-keys.enum.ts");
/* harmony import */ var _configuration_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./configuration.service */ "./src/app/core/services/configuration.service.ts");
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http, configurationService) {
        this.http = http;
        this.configurationService = configurationService;
        this.AUTH_URL = '/auth';
        this.FACILITY_URL = '/facility';
        this.currentUserSubject = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](JSON.parse(localStorage.getItem(_shared_enums_localstroage_local_storage_item_keys_enum__WEBPACK_IMPORTED_MODULE_1__["LocalStorageItemKeys"].CURRENT_USER)));
    ...
    AuthenticationService.prototype.login = function (loginDto) {
        var _this = this;
        return this.http.post("" + this.configurationService.config.BASE_URL + this.AUTH_URL + "/login", loginDto)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (user) {
            // login successful if there's a jwt token in the response
            if (user && user.access_token) {
                // store user details and jwt token in local storage to keep user logged in between page refreshes
                localStorage.setItem(_shared_enums_localstroage_local_storage_item_keys_enum__WEBPACK_IMPORTED_MODULE_1__["LocalStorageItemKeys"].CURRENT_USER, JSON.stringify(user));
                _this.currentUserSubject.next(user);
            }
            return user;
        }));
    };
    AuthenticationService.prototype.registerFacility = function (payload) {
        var _this = this;
        return this.http.post("" + this.configurationService.config.BASE_URL + this.FACILITY_URL + "/register", payload)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (user) {
            // login successful if there's a jwt token in the response
            if (user && user.token) {
                // store user details and jwt token in local storage to keep user logged in between page refreshes
    ...
    AuthenticationService.prototype.logout = function () {
        ...
        localStorage.removeItem(_shared_enums_localstroage_local_storage_item_keys_enum__WEBPACK_IMPORTED_MODULE_1__["LocalStorageItemKeys"].CURRENT_USER);
...
/***/ "./src/app/shared/enums/localstroage/local-storage-item-keys.enum.ts":
/*!***************************************************************************!*\
  !*** ./src/app/shared/enums/localstroage/local-storage-item-keys.enum.ts ***!
  \***************************************************************************/
/*! exports provided: LocalStorageItemKeys */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LocalStorageItemKeys", function() { return LocalStorageItemKeys; });
var LocalStorageItemKeys;
(function (LocalStorageItemKeys) {
    LocalStorageItemKeys["CURRENT_USER"] = "currentUser";
})(LocalStorageItemKeys || (LocalStorageItemKeys = {}));
